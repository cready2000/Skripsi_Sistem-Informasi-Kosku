                        ...
                        <div class="card border-0 shadow rounded-3 mb-5">
                            <div class="card-body p-4 p-sm-4">
                                <div class="form-group mb-2">
                                    ...
                                    <?php endforeach; ?>
                                    <?php foreach ($radius500 as $r) : ?>
                                        <a href="<?= base_url('penyewa/radius/' . $r['JARAK_RADIUS']) ?>"><button class="btn" style="background: #3ec1d5;border: none;color: white;padding: 10px 20px;text-align: center; text-decoration: none;display: inline-block;margin: 4px 2px;cursor: pointer;border-radius: 16px;">500 Meter</button></a>
                                    <?php endforeach; ?>
