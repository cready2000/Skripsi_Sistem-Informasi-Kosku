                                ...
                                <div class="card mt-3" style="margin:0 auto;max-width:38rem;">
                                    ...
                                    <div class="mb-3">
                                        <?php if (intval($dk['STOK_KAMAR']) > 0) : ?>
                                            <a href="<?= base_url('penyewa/detail-kamar/' . $dk['NAMA_KAMAR']) ?>"><button class="btn btn-dark" style="float: right;border: none;color: white;padding: 10px 20px;text-align: center; text-decoration: none;display: inline-block;margin: 4px 2px;cursor: pointer;border-radius: 16px; margin-right: 10px;">DETAIL KAMAR</button></a>
                                        <?php else : ?>
                                            <a href="<?= base_url('penyewa/detail-kamar/' . $dk['NAMA_KAMAR']) ?>"><button class="btn btn-dark" style="float: right;border: none;color: white;padding: 10px 20px;text-align: center; text-decoration: none;display: inline-block;margin: 4px 2px;cursor: pointer;border-radius: 16px; margin-right: 10px;" disabled>DETAIL KAMAR</button></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endforeach; ?>
