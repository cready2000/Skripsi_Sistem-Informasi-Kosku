                                ...
                                <div class="card mb-3" style="margin:0 auto;max-width:50rem;">
                                    <div class="card-body">
                                        ...
                                        <center>
                                            ...
                                            <div class="mb-5">
                                                <a href="<?= base_url('penyewa/lihat-kamar/' . $dk['NAMA_KOS']) ?>"><button class="btn" style="background: #3ec1d5;border: none;color: white;padding: 10px 20px;text-align: center; text-decoration: none;display: inline-block;margin: 4px 2px;cursor: pointer;border-radius: 16px;">LIHAT KAMAR</button></a>
                                            </div>
                                        </center>
