...
<body>
    ...
    <?php if (@$_SESSION['registrasi']) { ?>
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Sukses',
                text: '<?= session("registrasi") ?>'
            })
        </script>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex justify-content-between">
            ...
            <div class="logo">
                <h1><a href="<?= base_url() ?>"><img src="/template/login_dan_registrasi/penyewa/assets/img/logo-sikosku4.png" class="mb-2" width="75" alt="logo" /><span>Si</span> Kosku</a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a class="nav-link scrollto active" href="#"><span>Login</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
    ...
    <script src="/template/login_dan_registrasi/penyewa/assets/vendor/php-email-form/validate.js"></script>
