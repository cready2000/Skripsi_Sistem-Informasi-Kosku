...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex justify-content-between">
            ...
            <div class="logo">
                <h1><a href="<?= base_url() ?>"><img src="/template/penyewa/assets/img/logo-sikosku4.png" class="mb-2" width="75" alt="logo" /><span>Si</span> Kosku</a></h1>
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active" style="background-image: url(/template/penyewa/assets/img/hero-carousel/1.jpg)">
                        <div class="carousel-container">
                            <div class="container">
                                <h2 class="animate__animated animate__fadeInDown">Selamat Datang di Website Si Kosku</h2>
