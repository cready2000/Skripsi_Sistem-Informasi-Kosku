...
<head>
    ...
    <link rel="stylesheet" href="/template/admin/assets/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
    <link rel="stylesheet" href="/template/admin/assets/vendors/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" type="text/css" href="/template/admin/assets/js/select.dataTables.min.css">
...
<body>
    <script>
        $(document).on("click", "#alert_notif3", function() {
            var link = document.location.origin + "/login/logout3";
            var infoLogout3 = document.location.origin + "/login/infoLogout3";
            Swal.fire({
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="<?= base_url('admin') ?>"><img src="/template/admin/assets/images/logo-sikosku2.png" class="ml-3" alt="logo" />
                </a>
                <a class="navbar-brand brand-logo-mini" href="<?= base_url('admin') ?>"><img src="/template/admin/assets/images/logo-sikosku3.png" alt="logo" /></a>
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                <button class="navbar-toggler navbar-toggler align-self-center" type="button" data-toggle="minimize">
                    <span class="icon-menu"></span>
                </button>
                <div style="color: black;padding: 10px 50px 5px 810px;font-size: 16px;">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="/template/admin/assets/images/faces/human.png" alt="profile" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                            ...
                            <a class="dropdown-item" id="alert_notif3">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('/data-pemilik-kos') ?>">
                            <i class="icon-head menu-icon"></i>
                            <span class="menu-title">Data Pemilik Kos</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('/penarikan-saldo') ?>">
    ...
    <script src="/template/admin/assets/vendors/datatables.net/jquery.dataTables.js"></script>
    <script src="/template/admin/assets/vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
    <script src="/template/admin/assets/js/dataTables.select.min.js"></script>
    ...
    <script src="/template/admin/assets/js/Chart.roundedBarCharts.js"></script>
